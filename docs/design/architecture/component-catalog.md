...
See [Cosine Spline Charts](../architecture/cosine-spline-charts.md) for the `LineChart` rendering math and usage example.

## See also
- [FlexBox Layout](../architecture/flexbox-layout.md)
- [Downstream App Example](../architecture/downstream-example.md)
- [Keyboard Focus Engine](../architecture/keyboard-focus-engine.md)
