...
That third distinction is critical. A native app can be alive and rendering correctly while still being occluded, backgrounded, or partially off-screen — see [Capture Modes](../automation/capture-modes.md).
...
[Android Presenter](../architecture/android-presenter.md) for the
...
[Performance And Latency Profiling](../automation/perf-profiling.md).
