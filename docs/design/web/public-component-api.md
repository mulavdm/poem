...
[Family Packages](../web/family-packages.md).
...
fields described in [Trusted HTML](../web/trusted-html.md).
...
[Asset Delivery](../web/component-asset-delivery.md).
...
- [Family Packages](../web/family-packages.md) — how renderers are grouped
- [Trusted HTML](../web/trusted-html.md) — the escaped/trusted field split
- [Downstream Consumption](../web/downstream-consumption.md) — importing and serving it
