...
[Trusted HTML](../web/trusted-html.md) intact.
...
behind versioned URLs; see [Asset Delivery](../web/component-asset-delivery.md).
...
listener. See [Vanilla Class-Based JS](../web/vanilla-class-based-js.md).
...
enhancement. See [Accessibility](../web/accessibility.md).

## Version expectations

The exported Go API, the `poem-` CSS classes, and the `data-poem-*` attributes
are pre-v1 contracts, described in
[Public Component API](../web/public-component-api.md). They may change
