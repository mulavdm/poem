...
interface. See [POEM Backend](../app/desktop-driver.md) and
[Web Backend](../app/web-backend.md) for how each does it.
...
backend-specific is tracked in [Component Parity](../app/component-parity.md).
...
button) rather than beside it. See [Desktop Driver](../app/desktop-driver.md) for how each
...
visibility is chrome). See [Component Parity](../app/component-parity.md) for the general
...
[Composite Components](../../adr/0001-composite-components.md) for that decision and its
consequences.
