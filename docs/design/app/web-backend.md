...
[Sister Project](../../adr/0002-consolidation.md) for why that departure is scoped to this
...
[Architecture Overview](../app/TDD.md) for why that's correct, not a gap) — the
...
[map scene protocol](../../reference/protocol.md) and shared maths described in
[GPU Vector Map Rendering](../architecture/map-rendering.md). Camera and feature
