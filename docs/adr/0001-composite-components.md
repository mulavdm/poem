...
has a 1:1 component for them (see [Component Parity](../design/app/component-parity.md)). A
...
serializable rather than a Go closure (see [Architecture Overview](../design/app/TDD.md)) —
...
gaining routing) is a real architectural change and is recorded in the [log](../archive/okf-bundle-log.md), not a
silent edit.
