> **Superseded 2026-07-16** by [Consolidation](0002-consolidation.md): the two repos merged into this one. The structural findings below (state model, trust boundary) remain true and shaped the consolidation.
