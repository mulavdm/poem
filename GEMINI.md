<!-- AUTO-GENERATED by `workspace.exe sync-docs` -- do not edit directly.
     Source of truth: AGENTS.md in this directory. Edit that file, then
     run `workspace.exe sync-docs` to regenerate this mirror. -->
