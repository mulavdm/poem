...
.poem-workspace__body{display:grid;grid-template-columns:minmax(20rem,24rem) minmax(0,1fr);min-height:0}.poem-workspace__content{grid-column:2;grid-row:1;min-width:0;min-height:0;background:var(--poem-surface-muted)}.poem-workspace__tools{grid-column:1;grid-row:1;min-width:0;min-height:0;border-right:1px solid var(--poem-line);background:var(--poem-surface-raised);overflow:hidden}.poem-workspace__tools-scroll,.poem-workspace__detail-scroll{height:100%;overflow:auto;padding:var(--poem-space-lg);display:flex;flex-direction:column;gap:var(--poem-space-md);scrollbar-color:var(--poem-line-strong) var(--poem-surface-raised)}.poem-workspace__detail{display:none;min-width:0;min-height:0;border-right:1px solid var(--poem-line);background:var(--poem-surface-raised);overflow:hidden}.poem-workspace__handle{display:none}
