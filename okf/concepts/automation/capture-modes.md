---
type: Concept
title: Capture Modes & Native State
description: The three frame-capture sources (self/window/desktop), native-state fields, and why the distinction matters.
tags: [automation, capture, native-state, inspection]
