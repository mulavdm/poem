---
type: Concept
title: Window Preparation & Inspect Flow
description: POST /prepare-window and POST /inspect-frame, and the recommended agent inspection workflow.
tags: [automation, inspection, window-control]
