...
type: decision
title: Consolidation
description: GopherWeb and Trellis merged into POEM — one repository, one public application API (App[S]/Node), with the component API as the engine layer beneath it.
tags: [architecture, decisions, app, web, trellis, gopherweb]
