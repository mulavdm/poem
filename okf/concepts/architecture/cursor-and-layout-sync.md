---
type: Concept
title: Dynamic Cursor System and Layout Synchronization
description: How POEM drives native OS cursor state and keeps layout bounds pre-evaluated before hit-testing.
tags: [architecture, cursor, layout, hit-testing, win32]
