---
type: concept
title: Vanilla Class-Based JS
description: Why the component JavaScript is one dependency-free class that progressively enhances server-rendered HTML.
tags: [components, javascript, progressive-enhancement, accessibility]
...
API; see [Public Component API](/concepts/web/public-component-api.md).

## Relationships

- [Accessibility](/concepts/web/accessibility.md) — the keyboard and semantic behavior these bindings add
- [Asset Delivery](/concepts/web/component-asset-delivery.md) — how the file is embedded and served
- [Downstream Consumption](/concepts/web/downstream-consumption.md) — re-initialising after dynamic DOM changes
